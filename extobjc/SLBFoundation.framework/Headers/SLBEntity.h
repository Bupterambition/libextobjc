...
//  SLBiPhoneSDK
//
//  Created by senmmiao on 16-8-25.
//  Copyright (c) 2016年 bupt. All rights reserved.
//

#import <Foundation/Foundation.h>
#import <AutoCoding/AutoCoding.h>
#import "NSObject+SLBEntity.h"


/**
 *  所有实体类的基类，包含了实体序列化、反序列化的方法
 */
@interface SLBEntity : NSObject<NSCopying, SLBEntityProtocol>
